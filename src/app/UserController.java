...
public class UserController extends LoginController implements Initializable {
    ...
    private void toPatients(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("UPatient.fxml"));
    ...
    @FXML
    private void toApp(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("UApp.fxml"));
        Scene scene = new Scene(root);
        Stage stage = new Stage();
        stage.setScene(scene);
        stage.setResizable(false);
